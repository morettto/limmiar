...
const verifyMagicLinkMock = vi.mocked(client.verifyMagicLink)
const completeWebAuthnCeremonyMock = vi.mocked(client.completeWebAuthnCeremony)
...
describe('MagicLinkCallback', () => {
  ...
  it('ignores a late verifyMagicLink resolution after the component unmounted', async () => {
    let resolveVerify!: (value: Awaited<ReturnType<typeof client.verifyMagicLink>>) => void
  ...
  it('ignores a late completeWebAuthnCeremony resolution after the component unmounted', async () => {
    ...
    let resolveComplete!: (value: Awaited<ReturnType<typeof client.completeWebAuthnCeremony>>) => void
